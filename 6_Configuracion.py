...
ui.title("Configuración y Perfil", "Metas, ayuno, y ajustes del sistema")
...
with st.form("profile_form"):
    ...
    with c2:
        ...
        fasting_plan_hours = st.selectbox(
            "Plan de Ayuno (horas)",
            options=[12, 14, 16, 18, 20],
            index=[12, 14, 16, 18, 20].index(int(current_profile.get('fasting_plan_hours', 16))),
        )
    ...
    if submitted:
        new_profile = {
            ...
            'fasting_plan_hours': int(fasting_plan_hours)
        }
